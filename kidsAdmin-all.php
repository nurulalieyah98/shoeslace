...
<?php
	$kids="Kids";
	include "dbcon.php";
	$sql = "SELECT shoes_code, shoes_name, shoes_colour, shoes_brand, shoes_category, shoes_price, shoes_qty, shoes_image FROM shoes WHERE shoes_category='$kids' ORDER BY shoes_code";
