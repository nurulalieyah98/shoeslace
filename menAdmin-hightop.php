...
<html>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<table border="1" align="center" width="900">
		...
		<th background="images/backtable.jpg"><font color="white">Image</font></th><th background="images/backtable.jpg"><font color="white">Edit Item</font></th><th background="images/backtable.jpg"><font color="white">Delete Item</font></th></tr>
...
<?php
	...
	while($row = mysqli_fetch_assoc($result))
	{
        Print '<tr align="center">
                  ...
                  <td><a href="delete-menAdmin-hightop.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_delete.gif" width="17" height="17" onclick="return myFunction();"/></a></td>
                </tr>';		   
	}
