	...
	<div id="page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="alladmin.php">Home</a></span> / <span>Men</span></p>
					</div>
				</div>
			</div>
		</div>
...
<?php
	...
	while($row = mysqli_fetch_assoc($result))
	{
        Print '<tr align="center">
                  ...
                  <td><a href="delete-menAdmin-lowtop.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_delete.gif" width="17" height="17" onclick="return myFunction();"/></a></td>
                </tr>';		   
	}
