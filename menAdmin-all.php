...
<?php
	$men="Men";
	include "dbcon.php";
	$sql = "SELECT shoes_code, shoes_name, shoes_colour, shoes_brand,shoes_category, shoes_type, shoes_price, shoes_qty, shoes_image FROM shoes WHERE shoes_category='$men' ORDER BY shoes_type";
...
if ($r = $mysqli->query("SELECT * FROM shoes WHERE shoes_category='Men'")) {
