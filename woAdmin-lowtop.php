...
<?php
	...
	$type="Low Top";
	include "dbcon.php";
	$sql = "SELECT shoes_code, shoes_name, shoes_colour, shoes_brand, shoes_category, shoes_price, shoes_qty, shoes_image FROM shoes WHERE shoes_category='$women' AND shoes_type='$type' ORDER BY shoes_code";
	...
	while($row = mysqli_fetch_assoc($result))
	{
        Print '<tr align="center">
                  ...
                  <td><a href="delete-woAdmin-lowtop.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_delete.gif" width="17" height="17" onclick="return myFunction();"/></a></td>
                </tr>';		   
	}
