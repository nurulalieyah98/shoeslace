	...
	<div id="page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="alladmin.php">Home</a></span> / <span>All Categories</span></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-5 col-md-5">
			            <form action="allcategory.php" method="post" name="search" class="search-wrap">
			               <div class="form-group">
			                 <td width="450" align="center"> <input id="myInput" onkeyup="myFunction()" class="form-control search" placeholder="Shoe's Code">
			                 <script>
								function myFunction() 
								{
...
<?php
	...
	{
			$qty=shoes.shoes_qty-purchase.purchase_qty;
        ...
        Print '<tr align="center">
        		<td height="66">'.$count.'</td>
                  ...
                  <td>'.$row['shoes_qty'].'</td>
                  <td><img src="'.$row['shoes_image'].'" style= "width:120px;height:120px;"></td>

                  <td><a href="editcategory.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_edit.gif" width="17" height="17"/></a></td>
                  <td><a href="deletealladmin.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_delete.gif" width="17" height="17" onclick="return myFunction();"/></a></td>
                </tr>';	
                $count=$count+1;	   
	}
