...
<h3 align="center"><font face="Tw Cen Mt" >ADMIN DETAILS :</font><img src="images/adminfemale.png" width="100" height="100"></h3>;
	<br>

<?php
	include "dbcon.php";

	$sql = "SELECT admin_id, admin_name, admin_pass FROM admin";
	$count=1;
	$result = mysqli_query($connection, $sql);

	echo"<table border='1' align='center' width='450' id='customer' cellpadding='10'>";
	echo"<form action='allcategory.php' method='post' name='search' class='search-wrap'>";

	while($row = mysqli_fetch_assoc($result))
	{
		print'<tr align="center" colspan="2">';
		print'<th background="images/backtable.jpg"><font color="white">Admin ID : </font></th>';
		print'<td>'.$row['admin_id'].'</td>';
		print'</tr>';

		print'<tr align="center">';
		print'<th background="images/backtable.jpg"><font color="white">Name : </font></th>';
		print'<td>'.$row['admin_name'].'</td>';
		print'</tr>';

		print'<tr align="center">';
		print'<th background="images/backtable.jpg"><font color="white">Password : </font></th>';
		print'<td>'.$row['admin_pass'].'</td>';
		print'</tr>';

		print'<tr align="center">';
		print'<th background="images/backtable.jpg"><font color="white">Edit : </font></th>';
		print'<td><a href="editadmin1.php?admin_id='.$row['admin_id'].'"><img src="images/btn_edit.gif" width="20" height="20"></a></td>';
		print'</tr>';
		$count=$count+1;
	}
echo"</form>";
