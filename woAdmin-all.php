	...
	<div id="page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="alladmin.php">Home</a></span> / <span>Women</span></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="breadcrumbs-img" style="background-image: url(images/womensheader.jpg);">
							<h2></h2>
						</div>
						<div class="menu text-center">
							<p><a href="woAdmin-all.php">All Types</a><a href="woAdmin-lowtop.php">Low Top</a> <a href="woAdmin-midtop.php">Mid Top</a> <a href="woAdmin-hightop.php">High Top</a></p>
						</div>
					</div>
				</div>
			</div>
...
<?php
	$women="Women";
	include "dbcon.php";
	$sql = "SELECT shoes_code, shoes_name, shoes_colour, shoes_brand, shoes_type, shoes_price, shoes_qty, shoes_image FROM shoes WHERE shoes_category='$women'  ORDER BY shoes_type";
	$count=1;
	...
	while($row = mysqli_fetch_assoc($result))
	{
        Print '<tr align="center">
				  ...
				  <td>'.$row['shoes_type'].'</td>
				  <td>'.$row['shoes_price'].'</td>
                  <td>'.$row['shoes_qty'].'</td>

                   <td><img src="'.$row['shoes_image'].'" style= "width:128px;height:128px;"></td>
                  <td><a href="editcategory.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_edit.gif" width="17" height="17"</a></td>
                  <td><a href="delete-woAdmin-all.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_delete.gif" width="17" height="17" onclick="return myFunction();"/></a></td>
                </tr>';	
                $count=$count+1;	   
	}
...
if ($r = $mysqli->query("SELECT * FROM shoes WHERE shoes_category='Women'")) {

    /* determine number of rows result set */
    $row_cnt = $r->num_rows;
	printf("</br>");
    printf("<h6>Total Items : %d</h6>\n", $row_cnt);
