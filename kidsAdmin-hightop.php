	...
	<div id="page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="alladmin.php">Home</a></span> / <span>Kids</span></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="breadcrumbs-img" style="background-image: url(images/kidsheader.jpg);">
							<h2></h2>
						</div>
						<div class="menu text-center">
							<p><a href="kidsAdmin-all.php">All Categories</a><a href="kidsAdmin-lowtop.php">Low Top</a> <a href="kidsAdmin-midtop.php">Mid Top</a> <a href="kidsAdmin-hightop.php">High Top</a></p>
						</div>
					</div>
				</div>
			</div>
...
<?php
	...
	$type="High Top";
	include "dbcon.php";
	$sql = "SELECT shoes_code, shoes_name, shoes_colour, shoes_brand, shoes_category, shoes_price, shoes_qty, shoes_image FROM shoes WHERE shoes_category='$kids' AND shoes_type='$type' ORDER BY shoes_code";
	...
	while($row = mysqli_fetch_assoc($result))
	{
        Print '<tr align="center">
                  ...
                  <td><a href="delete-kidsAdmin-lowtop.php?shoes_code='.$row['shoes_code'].'"><img src="images/btn_delete.gif" width="17" height="17" onclick="return myFunction();"/></a></td>
                </tr>';		   
	}
